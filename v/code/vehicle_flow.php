...
<!<!doctype html>
    ...
    <head>
        ...
        <!-- There is an issue with styling of this document. 
                It is unusual for the style of the code to be more than the actual content
            -->
        <style>
            p {
                font-size: 30px;
    ...
    <body>
        <form class="frame" action="vehicle_flow_results.php" method="post">
            ...
            <input type="text" style="text-transform:uppercase" name="numberplate" placeholder="Number Plate" maxlength="7" required="true" />
            <!-- 
            Vehicle category. -->
